...
import iconCalendarSvg from './assets/calendar.svg';
import iconCommentsSvg from './assets/comments.svg';
import iconContentSvg from './assets/content.svg';
import iconIncreaseSvg from './assets/increase.svg';
  ...
  return (
    <Card>
      ...
      <Row>
        <Col flex={1}>
          <StatisticItem
            icon={<img src={iconCalendarSvg} alt="calendar" style={{ width: 32, height: 32 }} />}
        ...
        <Col flex={1}>
          <StatisticItem
            icon={<img src={iconContentSvg} alt="content" style={{ width: 32, height: 32 }} />}
        ...
        <Col flex={1}>
          <StatisticItem
            icon={<img src={iconCommentsSvg} alt="comments" style={{ width: 32, height: 32 }} />}
        ...
        <Col flex={1}>
          <StatisticItem
            icon={<img src={iconIncreaseSvg} alt="increase" style={{ width: 32, height: 32 }} />}
